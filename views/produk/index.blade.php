			...
			<div class="span12">
				<section id="wrap-cat">
					<header class="wrap-header">
						<div class="display">
							<b>Display:</b>
							<a id="gridbutton" class="grid grid-icon pointer" data-toggle="tooltip" data-placement="top" data-original-title="View Grid Style">Grid View</a>
							<a id="listbutton" class="list list-icon pointer" data-toggle="tooltip" data-placement="top" data-original-title="View List Style">List View</a>
						</div>
						<div class="limit">
							<b>Show:</b>
							...
							<div class="wdt-products-wrapper">
								<div class="wdt-product active show">
									<a href="{{product_url($myproduk)}}" title="{{$myproduk->nama}}">
										{{HTML::image(product_image_url($myproduk->gambar1,'medium'), $myproduk->nama, array('alt' => ($myproduk->nama), 'title' => ($myproduk->nama), 'style'=>'min-height:199px'))}}
									</a>
					...
					<div class="wdt-product">
						<div class="wdt-products-wrapper">
							<div class="wdt-product active show">
								...
								<h4><a href="{{product_url($myproduk)}}" title="{{$myproduk->nama}}">{{short_description($myproduk->nama,25)}}</a></h4>
