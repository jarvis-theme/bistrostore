		...
		<div class="row-fluid">
			...
			<div class="span7">
				...
				{{Form::open(array('url'=>'member','method'=>'post','class'=>'register-form'))}}
					...
					<input class="input-block-level" type="text" placeholder="* Enter your address #1" id="inputaddress" name='alamat' value="{{Input::old("alamat")}}" required/>
					...
					<label class="checkbox inline">
						<input type="checkbox" id="inlineCheckbox1" value="option1" required> Saya telah membaca dan menyetujui <a href="{{URL::to('service')}}">Persyaratan Member</a>
					</label>
