									...
									<div class="row-fluid">
										<div class="span6">
											...
											<div class="control-group">
												...
												<div class="controls">
													{{Form::select('provinsi',array('' => '-- Pilih Provinsi --'), ($user ? $user->provinsi :(Input::old("provinsi")? Input::old("provinsi") :"")),array('id'=>'provinsi'))}}
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="companyaddress">Kota</label>
												<div class="controls">
												{{Form::select('kota',array('' => '-- Pilih Kota --') , ($user ? $user->kota :(Input::old("kota")? Input::old("kota") :"")),array('id'=>'kota'))}}
												</div>
											</div>
											<div class="control-group">
										...
										<div class="span6">
											...
											<div class="control-group">
												<label class="control-label" for="companypostalcity">Konfirmasi Password</label>
												<div class="controls">
